...
BOT_TOKEN = environ.get('BOT_TOKEN', "5892691626:AAFrgyxJ7A0ZRz6sodhCo1dQlZNVWf94LoI")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001880227951').split()]
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+6IOkJOb5P3liOWE9')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/cynitebackup')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+6IOkJOb5P3liOWE9')
...
FILE_CHANNEL_LINK = environ.get('FILE_CHANNEL_LINK', 'https://t.me/+jvuzUWXb3BBmZWE1')
HOW_DWLD_LINK = environ.get('HOW_DWLD_LINK', 'https://t.me/cynitemovies/3')

# Log Channels
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1001577994654))
RQST_LOG_CHANNEL = int(environ.get('RQST_LOG_CHANNEL', -1001577994654))
